<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_login.aspx.cs" Inherits="LMS.student.student_login" %>
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.html">
                        <h1 style="color:whitesmoke">Student Login</h1>
                    </a>
                </div>
                          ...
                          <asp:TextBox ID="password" runat="server" Class="form-control" placeholder ="password" TextMode="password"></asp:TextBox>
                           ...
                           <center><a href ="student_registration.aspx" style="color:black">Register Now</a></center>
                            <div class="alert alert-danger" id="error" runat="server" style="margin-top:10px; display:none">
                             <strong>Please enter a valid username or password</strong> 
                        </div>
                    </form>
                </div>
            </div>
